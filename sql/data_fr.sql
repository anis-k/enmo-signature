...
INSERT INTO actions (id, label, color, logo, event, mode, status_id, next_status_id) VALUES (1, 'Refuser', '#e74c3c', 'fas fa-backspace', 'openDialog', 'SIGN', 1, 3);
INSERT INTO actions (id, label, color, logo, event, mode, status_id, next_status_id) VALUES (2, 'Refuser', '#e74c3c', 'fas fa-backspace', 'openDialog', 'NOTE', 1, 3);
...
INSERT INTO actions (id, label, color, logo, event, mode, status_id, next_status_id) VALUES (5, 'Valider', '#2ecc71', 'fas fa-check-circle', 'confirmDialog', 'SIGN', 1, 2);
INSERT INTO actions (id, label, color, logo, event, mode, status_id, next_status_id) VALUES (6, 'Valider', '#2ecc71', 'fas fa-check-circle', 'confirmDialog', 'NOTE', 1, 2);
