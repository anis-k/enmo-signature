...
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (1, 'MAARCH/2019D/1', 'Réponse à votre demande', 'SIGN', 1, 'Barbara Bain', 1, 2, CURRENT_TIMESTAMP);
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (2, 'MAARCH/2019D/2', 'Accusé de Réception de votre demande intervenant dans le cadre d’une décision implicite d’acceptation', 'SIGN', 1, 'Charlotte Charles', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (3, 'MAARCH/2019D/3', 'Accusé de Réception de votre demande intervenant dans le cadre d’une décision implicite de rejet', 'SIGN', 1, 'Robert Renaud', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (4, 'MAARCH/2019D/4', 'Invitation pour échanges journée des sports', 'SIGN', 1, 'Barbara Bain', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (5, 'MAARCH/2019D/5', 'Votre demande de place en crèche', 'SIGN', 1, 'Sabrina Saporta', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (6, 'MAARCH/2019D/6', 'Mécontentement délais de réponses place crèche', 'SIGN', 1, 'Sabrina Saporta', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (7, 'MAARCH/2019A/6', 'Pétition pour la survie du square Carré', 'NOTE', 1, 'Robert Renaud', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (8, 'MAARCH/2019A/7', 'Félicitations élections', 'NOTE', 1, 'Robert Renaud', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (9, 'MAARCH/2019A/8', 'Demande place creche', 'NOTE', 1, 'Sabrina Saporta', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (10, 'MAARCH/2019A/9', 'Demande subvention Jokkolabs', 'NOTE', 1, 'Robert Renaud', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (11, 'MAARCH/2019A/10', 'Facture Maarch', 'NOTE', 1, 'Suzanne Star', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (12, 'MAARCH/2019A/11', 'Demande état civil', 'NOTE', 1, 'Robert Renaud', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (13, 'MAARCH/2019A/12', 'Arrêt maladie vide', 'NOTE', 1, 'Pierre Pruvost', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, title, mode, status, sender, processing_user, creator, creation_date)
VALUES (14, 'MAARCH/2019A/13', 'Inscription ecole', 'NOTE', 1, 'Sabrina Saporta', 1, 2, CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
