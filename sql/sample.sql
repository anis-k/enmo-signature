...
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (7, 'CCAS/2019A/1', 'Pétition pour la survie du square Carré', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'CCAS', 1, 'Jacques DUPONT', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (8, 'DGS/2019A/2', 'Félicitations élections', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'DGS', 1, 'Pierre BRUNEL', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (9, 'PE/2019A/3', 'Demande place creche', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'PE', 1, 'Eric MACKIN', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (10, 'DGS/2019A/4', 'Demande subvention Jokkolabs', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'DGS', 1, 'Carole COTIN', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (11, 'FIN/2019A/5', 'Facture Maarch', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'FIN', 1, 'Carole COTIN', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (12, 'DGS/2019A/6', 'Demande état civil', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'FIN', 1, 'Martin Donald PELLE', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (13, 'DGS/2019A/7', 'Arrêt maladie vide', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'FIN', 1, '?', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
...
--
INSERT INTO main_documents (id, reference, subject, mode, status, priority, sender, sender_entity, processing_user, recipient, creation_date) 
VALUES (14, 'DGS/2019A/8', 'Inscription ecole', 'NOTE', 1, 'Urgent', 'Jenny Jane', 'FIN', 1, 'Martin MACKIN', CURRENT_TIMESTAMP);
INSERT INTO adr_main_documents (main_document_id, type, path, filename, fingerprint) 
